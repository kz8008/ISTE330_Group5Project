...
public class MainDataLayer {
    ...
    // ---------------------------
    public int addProfessor(int professorID, String fname, String lname, String buildingCode, String officeNum,
            String email, String phone, Integer accountID) {
        try {
            if (professorID > 0) {
    ...
    // getKeywordIdByName: find id but do not create new keyword (useful for
    // delete/search)
    ...
    public List<String> viewProfessorInterests(int professorID) {
        ...
        String sql = "select term from keyword inner join professorkeyword using(keywordID) where professorID = ?";
    ...
    // Student CRUD
    // ---------------------------
    public int addStudent(int studentID, String firstName, String lastName, String major, String email, String phone,
            Integer accountID) {
        try {
            if (studentID > 0) {
    ...
    public List<String> searchProfessorByInterest(String interest) {
        ...
        String sql = "SELECT CONCAT(p.firstName,' ', p.lastName) AS 'ProfessorName'," +
    ...
    public List<String> searchStudentByInterest(String interest) {
        ...
        String sql = "SELECT s.firstName, s.lastName, s.major, s.email " +
                "FROM Student s " +
    ...
    public List<String> searchAbstracts(String text) {
        ...
        String sql = "SELECT abstractID, title, abstractText " +
                "FROM Abstract " +
        ...
        try (PreparedStatement ps = conn.prepareStatement(sql)) {
            ...
            try (ResultSet rs = ps.executeQuery()) {
                while (rs.next()) {
                    String formatted =  rs.getString("title") + "\n" +
    ...
    public List<String> searchProfessorsByAbstractText(String text) {
        ...
        try (PreparedStatement ps = conn.prepareStatement(sql)) {
            ...
            try (ResultSet rs = ps.executeQuery()) {
                while (rs.next()) {
                    String formatted = "Professor: " + rs.getString("firstName") + " " + rs.getString("lastName") + "\n"
                            +
    ...
    public List<String> getProfessorAbstracts(int professorID) {
        ...
        String sql = "SELECT a.abstractID, a.title, a.abstractText " +
                "FROM Abstract a " +
